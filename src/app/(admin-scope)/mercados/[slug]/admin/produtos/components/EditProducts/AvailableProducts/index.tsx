...
import { handleOpenEditProductModal } from '@/utils/customEvents/@handlers/products/handleOpenEditProductModal'
...
export const AvailableProducts: React.FC<AvailableProductsProps> = ({
  ...
  return (
    <div className="grid h-auto w-fit max-w-full grid-cols-1 items-stretch gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8 2xl:grid-cols-5">
        ...
        >
          <figure className="relative flex w-full items-center justify-center rounded-sm lg:h-[150px] xl:h-[180px]">
            <Image
              ...
              className="w-full object-contain lg:h-[150px] xl:h-[180px]"
              height={1080}
              width={1980}
            />
            <span className="absolute right-2 top-2 bg-yellow-600 px-2 py-0.5 text-xs text-white xl:right-4 xl:top-4">
              Categoria
            </span>
          </figure>
